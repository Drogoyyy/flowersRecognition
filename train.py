...
MODEL_DIR = 'C:/Users/82622/Desktop/flowersRecognition/inception_model'
# 下载的谷歌训练好的inception-v3模型文件名
MODEL_FILE = 'classify_image_graph_def.pb'
 
# 保存训练数据通过瓶颈层后提取的特征向量
CACHE_DIR = 'C:/Users/82622/Desktop/flowersRecognition/tmp/bottleneck'
 
# 图片数据的文件夹
INPUT_DATA = 'C:/Users/82622/Desktop/flowersRecognition/data/flower_photos'
...
def main():
    ...
    with tf.Session(graph=graph) as sess:
        ...
        with tf.gfile.FastGFile("C:/Users/82622/Desktop/flowersRecognition/model/nn.pb", mode='wb') as f:
